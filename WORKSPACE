...
http_file(
    name = "xctestrunner",
    executable = 1,
    urls = ["https:@org_tensorflow//github.com/google/xctestrunner/releases/download/0.2.6/ios_test_runner.par"],
)
...
http_archive(
    ...
    urls = ["https:@org_tensorflow//github.com/bazelbuild/bazel-skylib/archive/0.7.0.tar.gz"],
)
...
http_archive(
    ...
    urls = ["https:@org_tensorflow//github.com/bazelbuild/apple_support/archive/0.5.0.tar.gz"],
)
...
http_archive(
    name = "inception_v1",
    build_file = "@org_tensorflow//:models.BUILD",
    sha256 = "7efe12a8363f09bc24d7b7a450304a15655a57a7751929b2c1593a71183bb105",
    urls = [
        "http:@org_tensorflow//storage.googleapis.com/download.tensorflow.org/models/inception_v1.zip",
        "http:@org_tensorflow//download.tensorflow.org/models/inception_v1.zip",
    ],
)
...
http_archive(
    ...
    urls = [
        "http:@org_tensorflow//storage.googleapis.com/download.tensorflow.org/models/object_detection/ssd_mobilenet_v1_android_export.zip",
        "http:@org_tensorflow//download.tensorflow.org/models/object_detection/ssd_mobilenet_v1_android_export.zip",
    ],
)
...
http_archive(
    ...
    urls = [
        "http:@org_tensorflow//storage.googleapis.com/download.tensorflow.org/models/mobile_multibox_v1a.zip",
        "http:@org_tensorflow//download.tensorflow.org/models/mobile_multibox_v1a.zip",
    ],
)
...
http_archive(
    ...
    urls = [
        "http:@org_tensorflow//storage.googleapis.com/download.tensorflow.org/models/stylize_v1.zip",
        "http:@org_tensorflow//download.tensorflow.org/models/stylize_v1.zip",
    ],
)
...
http_archive(
    ...
    urls = [
        "http:@org_tensorflow//storage.googleapis.com/download.tensorflow.org/models/speech_commands_v0.01.zip",
        "http:@org_tensorflow//download.tensorflow.org/models/speech_commands_v0.01.zip",
    ],
)
